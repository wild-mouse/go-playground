...
import (
	...
	filesapi "github.com/wild-mouse/go-playground"
...
func main() {
	...
	{
		logger = log.New(os.Stderr, "[filesapi] ", log.Ltime)
	}
	...
	{
		filesSvc = filesapi.NewFiles(logger)
	}
	...
	case "development":
		{
			addr := "http://localhost:8000/files"
			...
			handleHTTPServer(ctx, u, filesEndpoints, &wg, errc, logger, *dbgF)
		}
